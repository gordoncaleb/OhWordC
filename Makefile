...
OhWordC : OhWordC.o Math.o Board.o Move.o Piece.o PositionBonus.o SecureRandom.o Side.o Values.o RNGTable.o BitBoard.o BoardMaker.o  Bishop.o Rook.o Knight.o Queen.o King.o Pawn.o
